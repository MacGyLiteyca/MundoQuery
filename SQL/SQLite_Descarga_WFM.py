...
if __name__ == "__main__":
    db = DatabaseManager('D:\\SQLite\\WFM_Claro.db')
    db.create_tables()

    excel_reader = ExcelReader(
        'C:\\Users\\User\\OneDrive - LITEYCA DE COLOMBIA S.A.S\\Compartido\\ProyectoClaroAnt\\DescargaWFMHoraHora'
    )
    ...
    for file in archivos_excel:
        if os.path.isfile(file):
            ...
            data = excel_reader.read_excel_sheet(file, 'DatosWF1')
